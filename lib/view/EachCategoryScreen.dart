import 'package:connectx_task_shopapp/controllers/EachCategory/cubit/cubit.dart';
...
import '../controllers/EachCategory/EachCategoryController.dart';
                    ...
                    child: Container(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(controller.Model!.data!.products!.length
                            , (index) => controller.BuildProductItem(controller.Model!.data!.products![index],context)),
                      ),
                    ),
                  )
                ],
